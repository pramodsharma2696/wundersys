...
<title>ForTradex - HTML 5 Template Preview</title>
            ...
            <nav class="menu-box">
                ...
                <div class="contact-info">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ asset('') }}tel:+8801682648101">+88 01682648101</a></li>
                        <li><a href="{{ asset('') }}mailto:info@example.com">info@example.com</a></li>
                    </ul>
                </div>
                <div class="social-links">
                    <ul class="clearfix">
                        <li><a href="{{ asset('') }}index.html"><span class="fab fa-twitter"></span></a></li>
                        <li><a href="{{ asset('') }}index.html"><span class="fab fa-facebook-square"></span></a></li>
                        <li><a href="{{ asset('') }}index.html"><span class="fab fa-pinterest-p"></span></a></li>
                        <li><a href="{{ asset('') }}index.html"><span class="fab fa-instagram"></span></a></li>
                        <li><a href="{{ asset('') }}index.html"><span class="fab fa-youtube"></span></a></li>
                    </ul>
                </div>
            </nav>
        </div>
