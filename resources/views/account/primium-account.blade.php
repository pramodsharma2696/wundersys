                ...
                <div class="col-lg-12 col-md-12 col-sm-12 content-column pb_70">
                        <div class="content_block_eight">
                            <div class="content-box ml_60">
                                ...
                                <span class="sub-title mb_14">What is a Wundersys Capital Limited Premium Account?</span>
                                <h2><span>An Premium, is a specialised trading account</span> that connects traders with liquidity providers such as a bank or any financial institution via an electronic network. <span>Wundersys Capital Limited's</span> Premium account offers unparalleled trading conditions designed for professional and high-frequency traders.</h2>
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-6 col-sm-12 account-block">
                                    ...
                                    <figure class="image-box">
                                                <img src="{{ asset('')}}assets/image/pa.png" alt="meta5" style="width:640px !important;max-width: none;">
                                    </figure>
                                    </div>
                        ...
                        <div class="content_block_eight">
                            <div class="content-box ml_60">
                                <div class="sec-title pb_20">
                                    ...
                                    <h2>Here’s why Traders Choose An <span>Premium Account:</span></h2>
                                </div>
                                <div class="text-box">
                                     <ul class="list-style-one mb_40 clearfix">
                                        <li>100+ Tradable Instruments: Access A Broad Range Of Financial Assets To Diversify Your Trading Portfolio.</li>
                                        <li>Instant Execution: Benefit From Premium Execution With Liquidity From Banks, Brokerages, And Clients.</li>
                                        <li>Multiple Order Types: Utilize Various Order Types To Implement Your Trading Strategies Effectively.</li>
                                        <li>Flexible Currency Denominations: Choose From USD, EUR, GBP For Your Account To Suit Your Trading Needs.</li>
                                        <li>Ultra-Low Spreads: Enjoy Spreads Starting From 0.0 PIPs* On EURUSD, Providing You With The Best Possible Trading Conditions.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="auto-container">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 content-column">
                        <div class="content_block_eight">
                            <div class="content-box ml_60">
                                <div class="sec-title pb_20">
                                <span class="sub-title mb_14">Why Choose Wundersys Capital Limited?</span>
                                <h2>we are committed to offering a premium trading environment with cutting-edge technology and access to extensive liquidity. Our Premium account is tailored for traders seeking the best execution speeds and the lowest spreads.</h2>
                                </div>
                            </div>
                        </div>
                    </div> 
