                ...
                <div class="col-lg-12 col-md-12 col-sm-12 content-column pb_70">
                        <div class="content_block_eight">
                            <div class="content-box ml_60">
                                ...
                                <span class="sub-title mb_14">Cryptocurrencies</span>
                                    <h2 class="mb_14">Cryptocurrencies on our platform</h2>
                                    <p>Explore the dynamic world of cryptocurrencies on our platform. Trade top digital assets with access to real-time markets. Diversify your portfolio with popular cryptocurrency CFDs and capture opportunities in this evolving asset class.</p>
                                </div>
                            </div>
                        </div>
                </div> 
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-6 col-sm-12 account-block">
                                    ...
                                    <figure class="image-box">
                                                <img src="{{ asset('')}}assets/image/crypto.png" alt="meta5" style="width:640px !important;max-width: none;">
                                    </figure>
                                    </div>
                        ...
                        <div class="content_block_eight">
                            <div class="content-box ml_60">
                                ...
                                <ul class="list-style-one mb_40 clearfix">
                                        <li><span style="font-weight: 700;">Flexible Account Options :</span>Tailored to meet your trading style and goals, giving you the freedom to trade your way.</li>
                                        <li><span style="font-weight: 700;">Comprehensive Market Access :</span>Trade multiple asset classes, from Forex and Equities to Indices and Commodities, all in one platform.</li>
                                        <li><span style="font-weight: 700;">Expertly Curated Experience :</span>Access premium tools, insights, and resources designed by industry professionals to enhance your trading journey.</li>
                                        <li><span style="font-weight: 700;">Transparent and Secure :</span>Built on trust, our platform ensures transparent pricing and secure transactions, so you can trade with confidence.</li>
