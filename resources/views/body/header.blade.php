<header class="main-header header-style-one">
                ...
                <div class="large-container">
                    <div class="top-inner">
                        ...
                        <div class="option-block">
                            ...
                            <a href="{{ asset('') }}index.html" class="theme-btn btn-one mr_10">Open Account</a>
                            <a href="{{ asset('') }}index.html" class="theme-btn btn-two">Login</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="header-lower">
                <div class="large-container">
                    <div class="outer-box">
                        <figure class="logo-box"><a href="{{ asset('') }}index.html"><img src="{{ asset('') }}assets/images/logo.png" alt=""></a></figure>
                        <div class="menu-area">
                                ...
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        <li class="current dropdown"><a href="{{ asset('') }}index.html">Home</a>
                                            <ul>
                                                <li><a href="{{ asset('') }}index.html">Home One</a></li>
                                                <li><a href="{{ asset('') }}index-2.html">Home Two</a></li>
                                                <li><a href="{{ asset('') }}index-3.html">Home Three</a></li>
                                                <li><a href="{{ asset('') }}index-4.html">Home Four</a></li>
                                                <li><a href="{{ asset('') }}index-5.html">Home Five</a></li>
                                            </ul>
                                        </li> 
